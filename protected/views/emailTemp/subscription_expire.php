...
<html lang="en">
  ...
  <body>
	...
	<div class="fix-table">
	  	...
	  	<p>One or more subscription are set to expire <?php echo $expire_day_text; ?>. Please review your subscription plan's expiration dates.</p>  
		<table style="width:640px; margin: 0 auto;">
			...
			<?php foreach($expire_subscriptions as $key => $subscription): ?>
			<tr>
				<td><?php echo $key+1; ?></td>
				<td><?php echo $subscription['package_name']; ?></td>
				<td><?php echo '$'.$subscription['amount']; ?></td>
				<td><?php echo date('m/d/Y',strtotime($subscription['expiry_date'])); ?></td>
				<td><?php echo ($subscription['duration']==1) ? 'Monthly' : 'Yearly'; ?></td>
		 	</tr>
		    <?php endforeach; ?>
		</table>

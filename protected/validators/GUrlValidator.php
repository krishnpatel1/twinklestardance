<?php
/**
 * GUrlValidator - a more relaxed alternative to CUrlValidator
 */

/**
 * GUrlValidator validates that the attribute value is a valid http or https URL.
 *
...
class GUrlValidator extends CValidator
{
  ...
  /**
   * @var its default false, if true then only match pattern 
   */
  public $customUrlKeyOnly=false;
  /**
  ...
  protected function validateAttribute($object,$attribute)
  {
    ...
    {
      $message=$this->message!==null?$this->message:Yii::t('yii','{attribute} is not a valid URL. It contains only alphanumeric, - and _ characters.');
  ...
  public function validateValue($value)
  {
    ...
    if($this->customUrlKeyOnly!=null) {
    	return preg_match($this->uriPattern,$value) ? $value : null;
    }

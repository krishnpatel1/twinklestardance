...
class JVWebApplication extends CWebApplication
{
	public $userComponent='customer';
	public $requestModule='';
	

	/**
	 * set User Componet : Admin / customer
	 * @param unknown_type $component
	 */
	public function setUser($component='customer')
	{
	...
	{
		return $this->getComponent($this->userComponent);
	}

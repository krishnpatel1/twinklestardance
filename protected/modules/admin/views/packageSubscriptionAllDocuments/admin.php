    ...
    'columns' => array(
        ...
        array(
            ...
            'buttons' => array
                ...
                'update' => array(
                    'url' => 'Yii::app()->createUrl(\'admin/packageSubscriptionAllDocuments/update\',array(\'id\' => $data->document->id))'
                ),
                'delete' => array(
                    'url' => 'Yii::app()->createUrl(\'admin/packageSubscriptionAllDocuments/delete\',array(\'document_id\' => $data->document->id,\'subscription_id\' => $data->subscription->id))'
                )
            ),
        )
    ),

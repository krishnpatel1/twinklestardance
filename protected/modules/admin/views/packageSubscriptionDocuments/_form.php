            ...
            <div class="basic_nav_center">
                ...
                <?php if ($model->id > 0): ?>
                    <div class="subscriptions">
                        ...
                        <div class="sub_left">
                            <?php
                            echo CHtml::link(CHtml::image(Yii::app()->baseUrl . "/images/icon/add_small.png", '', array('class' => 'icon')) . "Add Subscription", 'javascript:void(0);', array('onclick' => 'js:openColorBox("' . CController::createUrl("packageSubscriptionDocuments/addSubscription", array('id' => $model->id)) . '");return false;', 'class' => 'ajax buttons add_butt'));

            ...
            <?php if ($model->id > 0): ?>                
                <div class="subscriptions documents_tab">
                    ...
                    <div class="sub_left">
                        <h6>Videos:</h6>
                        <?php
                        echo CHtml::link(CHtml::image(Yii::app()->baseUrl . "/images/icon/add_small.png", '', array('class' => 'icon')) . "Add Videos", CController::createUrl("/user/classes/vtable/".$model->id), array('class' => 'buttons add_butt'));
                        $ssPostData = "class_id=" . $model->id;
                        if ($omClassVideos):

       ...
       /* 'email' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                // all documents  (jamal)//
                'user/all-documents' => 'admin/packageSubscriptionAllDocuments/admin',
                'user/all-document/add' => 'admin/packageSubscriptionAllDocuments/create',
                'user/all-document/edit/<id:\w+>' => 'admin/packageSubscriptionAllDocuments/update',
                'user/all-document/add/subscription/<id:\w+>' => 'admin/packageSubscriptionAllDocuments/addSubscription',
                'user/all-document/remove/subscription/<id:\w+>' => 'admin/PackageSubscriptionAllDocuments/removeSubscriptionFromDocument',
                'user/all-document/delete/<document_id:\w+>/<subscription_id:\w+>' => 'admin/packageSubscriptionAllDocuments/delete',
                'user/all-document/add/class/<id:\w+>' => 'admin/packageSubscriptionAllDocuments/addClassesToDocument',
                //'user/class/add/document/<id:\w+>' => 'admin/classes/addDocumentsToClass',
                //'user/class/remove/document/<id:\w+>' => 'admin/classes/removeDocumentToClass',
                // my accounts //
                ...
                // classes //
                'user/classes/vtable/<id:\w+>' => 'admin/classes/viewDetailsTable',
                ...
                'user/classes/videost/<id:\w+>' => 'admin/classes/listClassVideosTable',
                ...
                'user/classes/getClassesReport' => 'admin/classes/getClassesReport',
               ...
               // 'payment/recurring/<order_id:\w+>/<cart_ids:\w+==>' => 'site/recurringPayment',
                ...
                // by jamal for SOF 3.1
                'user/subscription/list' => 'admin/packageSubscription/activeSubscriptionList',
                'user/subscription/cancel' => 'admin/packageSubscription/cancelSubscription',
                'user/subscription/check' => 'admin/packageSubscription/checkExpiringSubscription',
            ),
        ),
        /*
          'db'=>array(
        ...
        'db' => array(
            'connectionString' => 'mysql:host=localhost;dbname=tsdliveinx',
            'emulatePrepare' => true,
            'username' => 'root',
            'password' => 'inx@!123',
            'charset' => 'utf8',

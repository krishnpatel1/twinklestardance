        ...
        <tbody>
          <tr>
            <td><!--<img src="images/icon/product.gif" alt="" width="24" height="24" border="0" class="admin_icon"/>-->
              <h3 class="icon-head head-promo-catalog">Package List
              </h3></td>
            <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="package_edit.php?package_id=<?=$package_id?>" class="bodytext_bold_link">Add Package</a></td>
          </tr>
        </tbody>
      </table>
    </div>
                ...
                <td align="left" valign="top"><table width="100%"  border="0" cellpadding="5" cellspacing="0" class="bodytext">
                    <form name="form1" method="post" action="">
                      ...
                      <tr align="center" valign="middle">
						...
						<th width="100" align="center" valign="middle" class="bodytext_title_white">Package Image</th>
                        <th width="200" align="center" valign="middle" class="bodytext_title_white">Package Name</th>
                      ...
                      <tr align="left" valign="top" class="box-bg">
                        ...
                        <td align="center" valign="middle"><a href="package_edit.php?id=<?=$data['package_id']?>&return_url=<?=urlencode($_SERVER['REQUEST_URI']);?>" class="bodytext_link">Edit</a></td>

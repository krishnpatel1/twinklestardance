...
define('TABLE_GALLERY',TPRE.'gallery');
define('TABLE_GALLERY_CATEGORY',TPRE.'gallery_category');
...
define('TABLE_RECURRING',TPRE.'recurring');
define('TABLE_ASSIGN_VIDEO',TPRE.'assign_video');
define('TABLE_GALLERY_PERMITION',TPRE.'gallery_permition');
define('TABLE_ORDER_VIDEO',TPRE.'order_video');
define('TABLE_PACKAGE_DOCUMENT',TPRE.'package_document');

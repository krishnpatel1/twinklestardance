        ...
        <td align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td height="40" align="left" valign="top" class="top_title"><h1>Confirm Order </h1></td>
				  </tr>
				  <tr>
						...
						<?php
							if($totrec>0)
							{
								...
								for($i=0;$i<$totrec;$i++)
								{
									...
									$cartpackage_id[]=$pro_id;//create package string for additional package chacking
									$gallery=$temp[$i]['gallery'];
									...
									/*================Gallery listing=====================*/
									$galName='';
									$videoId=explode(",",$gallery);
									foreach($videoId as $value)
									{
										$galArray=$obj->selectData(TABLE_GALLERY,"","gallery_id='".$value."'",1);
										$galName.=$galArray['gallery_name']."<br/>";
									}
									/*===================================================*/
						?>
								<tr>
									<td colspan="2">
										<table align="left" width="100%">
											<tr><td align="left"><?php echo $x++;?> ) &nbsp;<?php echo $pro_desc?></td></tr>
											<tr><td align="left"><b>Selected Video</b></td></tr>
											<tr><td align="left" style="padding-left:10px;"><?php echo $galName;?></td></tr>
										</table>
									</td>
								</tr>
						<?php 
				  ...
				  <tr>
					<td align="left" valign="top">
						<a href="online_packages.php"><img src="images/continue_btn.png" alt="" width="132" height="32" border="0" /></a> &nbsp; 
						<a href="<?php echo FURL_HTTPS; ?>subscription.php"><img src="images/con_order_btn.png" alt="" width="102" height="32" border="0" /></a>
					</td>
				  </tr>
				  <tr><td style="height:15px;"></td></tr>
				  <? if($obj->hasAdditionalpack()!=0){?>
				  <tr>
					<td align="left">
						<table align="left" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="left" class="top_title">
							...
							<?php
								if($totrec>0)
								{
									for($l=0;$l<$totrec;$l++)
									{
										$addpack_arr =$obj->selectData(TABLE_PACKAGE,"","package_id='".$temp[$l]['productid']."'",1);
										$pid=explode(',',$addpack_arr['package_additional_id']);
										foreach($pid as $val)
										{
											if(!in_array($val,$cartpackage_id))
											{
								...
								?>
									<tr>
										<td align="left">
											<a href="package-detail.php?id=<?=$package_arr['package_id']?>"><?php echo $package_arr['package_name'];?></a>
										</td>
									</tr>
								<?php			
											}

...
if(isset($_POST['btnDelete']))
{
	if(is_array($_POST['chkSelect']))
	{
		...
		{
			$deleteStatus = $obj->updateData(TABLE_DOWNLOADTYPE,array('down_type_status'=>'Deleted'),"down_type_id='".$chbx."'");
		}
...
$sql=$obj->selectData(TABLE_DOWNLOADTYPE,"","down_type_status<>'Deleted'".$extra."  order by down_type_name desc",2);
        ...
        <table width="100%" cellspacing="0">
          <tbody>
            <tr>
              ...
              <h3 class="icon-head head-promo-catalog">Product Type Listings</h3></td>
              <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="downloadtype_edit.php" class="bodytext_bold_link">Add Download Type</a></td>
            </tr>
          </tbody>
        </table>
      </div>
						...
						<form name="form1" method="post" action="">
						  <? if($pg_obj->totrecord){?>
							<tr align="center" valign="middle">
							  ...
							  <th width="350" align="center" valign="middle" class="bodytext_title_white">Download Type</th>
						   ...
						   <?php }?>
							...
							<tr align="left" valign="top" class="box-bg">
							  ...
							  <td align="center" valign="middle"><?=$data['down_type_name'];?></td>
							  <td align="center" valign="middle"><?=$data['down_type_status'];?></td>
							  <td align="center" valign="middle"><a href="downloadtype_edit.php?id=<?=$data['down_type_id'];?>&return_url=<?=urlencode($_SERVER['REQUEST_URI']);?>" class="bodytext_link">Edit</a></td>
							  <td align="center" valign="top"><input name="chkSelect[]" id="chkSelect1" type="checkbox" value="<?=$data['down_type_id'];?>" class="checkboxstyle"></td>
							</tr>
							<?
							}
							?>

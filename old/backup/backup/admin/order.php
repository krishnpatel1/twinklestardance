                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="2" class="tableborder_gray">
                      ...
                      <tr class="tr_bg">
                        ...
                        <td align="left" valign="top" class="black_text2"><span class="HD2dark"> 
                          ...
                          <?=$row['order_bill_st_add'];?><br/>
                          <?=$row['order_bill_city']?>
                          <br/>
                          <? $row['order_bill_state']?>&nbsp;&nbsp;<?=$row['order_bill_zip'];?><br/>
						   <span class="HD2dark"><strong>Credit Card Info:</strong></span><br/>
						   Card no :&nbsp;<?=$row['order_card'];?><br/>
						   Expiration Date:&nbsp;<?=$row['order_ex_date'];?><br/>
						   CVV Code:&nbsp; <?=$row['order_cvv'];?><br/>
                        </td>
                        ...
                        <td height="20" align="center" valign="top" ><select name="order_status[]" class="input">

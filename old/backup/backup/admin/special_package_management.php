...
if(isset($_POST['btnDelete'])){
	if(is_array($_POST['chkSelect'])){
		foreach($_POST['chkSelect'] as $chbx){
			$deleteStatus = $obj->updateData(TABLE_SPECIAL_PACKAGE,array('sp_package_status'=>'Deleted'),"sp_package_id='".$chbx."'");
		}
...
if($_REQUEST['search_sp_package_name']<>'')
{
	$extra .= "and sp_package_name='".$_REQUEST['search_sp_package_name']."'"; 
}
//echo $extra;
$sql=$obj->selectData(TABLE_SPECIAL_PACKAGE,"","sp_package_status<>'Deleted' ".$extra."  order by sp_package_id desc",2);
        ...
        <tbody>
          <tr>
            <td><!--<img src="images/icon/product.gif" alt="" width="24" height="24" border="0" class="admin_icon"/>-->
              <h3 class="icon-head head-promo-catalog">Special Package List
              </h3></td>
            <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="special_package_edit.php?sp_package_id=<?=$sp_package_id?>" class="bodytext_bold_link">Add Special Package</a></td>
          </tr>
        </tbody>
      </table>
    </div>
      ...
      <div id="promo_catalog_grid">
        ...
        <div>
          <form name="frmSearch" method="get" action="">
            ...
            <div style="font-size:12px; font-weight:bold;">Search by Package Name</div>
            Search:&nbsp;
            <input type="text" name="search_sp_package_name" >
            &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <form name="form1" method="post" action="">
                      ...
                      <tr align="center" valign="middle">
                        <th width="49" align="left" valign="middle" class="bodytext_title_white">#</th>
						 <th width="150" align="center" valign="middle" class="bodytext_title_white">Package Image</th>
                        <th width="150" align="center" valign="middle" class="bodytext_title_white">Package Name</th>
                      ...
                      <tr align="left" valign="top" class="box-bg">
                        <td align="left" valign="middle"><?=$i++; ?></td>
						 <td align="center" valign="middle"><?=$obj->getImageThumb(PACKAGE_IMG,$data['sp_package_image'],'','','100','100','../');?></td>
                        <td align="center" valign="middle"><?=$data['sp_package_name']?>
                        </td>
                        <td align="center" valign="middle"><?=$data['date_added'];?></td>
                        <td align="center" valign="middle"><?=$data['sp_package_status'];?></td>
                        <td align="center" valign="middle"><a href="special_package_edit.php?id=<?=$data['sp_package_id']?>&return_url=<?=urlencode($_SERVER['REQUEST_URI']);?>" class="bodytext_link">Edit</a></td>
                        <td align="center" valign="top"><input name="chkSelect[]" id="chkSelect1" type="checkbox" value="<?=$data['sp_package_id'];?>" class="checkboxstyle"></td>
                      </tr>
                      <?
							}
							?>

					...
					<div class="package-content">
						<?
							...
							if($data['package_price_subscription']<>0)
							{
								...
								echo $i++." ) ". $data['package_name']." monthly payment package <span style='color:red;'>$".$data['package_price_subscription']."</span> per month for ".$data['package_duration']." months.";
						 ?>
					  <ul>
					  ...
					  <?
							...
							if($data['package_price_onetime']<>0)
							{
								...
								echo $i++." ) ".$data['package_name']." Pay <b>up front package</b> - <span style='color:red;'>$".$data['package_price_onetime']."</span>";
					  ?>
					  <ul>

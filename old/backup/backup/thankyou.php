      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" align="left" valign="top" class="top_title"><h1>Thank You</h1></td>
              </tr>
			  <tr>
						...
						if($totrec>0)
						{
							...
							for($i=0;$i<$totrec;$i++)
							{
								...
								if($pro_type=='P')
								{
									...
									{
										$pro_desc=$package_fetch['package_name']." -- <b>Pay up front package</b> $".$package_fetch['package_price_onetime'];
									}
              ...
              <tr>
                <td align="left" valign="top" class="home_content">
						Thank you for subscribing to Twinkle Star
						Dance! Based on your order we will establish a custom gallery of videos <br />
						and email a password and access information within 24 hours. If
						you have any questions feel free to <br />
						email me at <a href="mailto:tiffany@tiffanydance.com">tiffany@tiffanydance.com</a>.		
				</td>
              </tr>
            </table>
			</td>

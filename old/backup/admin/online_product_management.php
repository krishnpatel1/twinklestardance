      ...
      <table width="100%" cellspacing="0">
        <tbody>
          <tr>
            ...
            <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="online_product_edit.php?product_id=<?=$product_id?>" class="bodytext_bold_link">Add Subscription</a></td>
          </tr>
        </tbody>
      </table>
    </div>

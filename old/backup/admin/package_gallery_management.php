...
$sql=$obj->selectData(TABLE_GALLERY_CATEGORY,"","category_uid='0' and category_status<>'Deleted'".$extra."  order by category_id desc",2);
        ...
        <table width="100%" cellspacing="0">
          <tbody>
            <tr>
              ...
              <h3 class="icon-head head-promo-catalog">Gallery Listings</h3></td>
              <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="package_gallery_edit.php" class="bodytext_bold_link">Add Gallery</a></td>
            </tr>
          </tbody>
        </table>
      </div>
						...
						<form name="form1" method="post" action="">
						  <? if($pg_obj->totrecord){?>
							<tr align="center" valign="middle">
							  ...
							  <th width="100" align="center" valign="middle" class="bodytext_title_white">Name</th>
						   ...
						   <?php }?>
							...
							<tr align="left" valign="top" class="box-bg">
							  ...
							  <td align="center" valign="middle"><?=$data['category_name'];?></td>
							  <td align="center" valign="middle"><?=$data['category_status'];?></td>
							  <td align="center" valign="middle"><a href="package_gallery_edit.php?id=<?=$data['category_id'];?>&return_url=<?=urlencode($_SERVER['REQUEST_URI']);?>" class="bodytext_link">Edit</a></td>
							  <td align="center" valign="top"><input name="chkSelect[]" id="chkSelect1" type="checkbox" value="<?=$data['category_id'];?>" class="checkboxstyle"></td>
							</tr>
							<?
							}
							?>

...
if($_REQUEST['action']=='addTocart')
{
	...
	if(trim($_POST['pack_type'])=="") {$obj->add_message("message","Choose Subscriptions Type!");}
	if($obj->get_message("message")=="")
	{
		...
		header("Location:video_select.php?prod_id=$prod_id&price=$price&p_type=$p_type&pack_type=$pack_type&duration=$duration");
		//header("Location:video_select.php?prod_id=$prod_id&price=$price&p_type=$p_type&dw_type=$dw_type");
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
         <span class="home_content" style="color:#ff0000;"> <? if($obj->get_message("message")<>"") { echo $obj->get_message("message");}?></span>
		  <tr>
            <td align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
				...
				<ul>
					<li>
						...
						STARS monthly payment Subscription <span style="color:red;">$<?=$package_fetch['package_price_subscription']?></span> per month for <?=$package_fetch['package_duration']?> Months
					</li>
					<li>

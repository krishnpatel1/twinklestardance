      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" align="left" valign="top" class="top_title"><h1>Ages 3 to 6</h1></td>
              </tr>
              <tr>
              ...
              <tr>
				...
				<p>For older children, we offer an age-specific, 45-minute class containing ballet, tap and jazz/creative movement. The purpose of the class is to introduce young dancers to the three styles of dance and inspire movement and creativity within a positive environment. Dancers will also learn basic steps and terminology in all three styles. </p>

...
if(isset($_POST['btnDelete']))
{
	if(is_array($_POST['chkSelect']))
	{
		...
		{
		$arr['assign_video_status']='Deleted';
			$deleteStatus = $obj->updateData(TABLE_ASSIGN_VIDEO,$arr,"assign_video_id='".$chbx."'");
...
/*   / delete data   */
$sql=$obj->selectData(TABLE_ASSIGN_VIDEO,"","assign_video_uid='$user_id' and assign_video_status<>'Deleted'".$extra."  order by assign_video_id desc",2);
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" align="left" valign="top" class="top_title"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="40" align="left" valign="top"><h1>Video Listing</h1></td>
              ...
              <tr>
				...
				<td align="right" valign="middle"><a href="list_video_edit.php" class="red_link">Add New Video</a></td>
				</tr>
				</table>
						...
						<form name="form1" method="post" action="">
						  <? if($pg_obj->totrecord){?>
							<tr align="center" valign="middle">
							  ...
							  <th width="20" align="center" valign="middle" class="bodytext_title_white">#</th>
							  <th align="left" valign="middle" class="bodytext_title_white">Gallery</th>
							  <th width="200" align="left" valign="middle" class="bodytext_title_white">Video Name</th>
						   ...
						   <?php }?>
							...
							<tr align="left" valign="top">
							  ...
							  <td align="left" valign="middle" class="box_pink"><?=$obj->get_usergallerycatName($data['assign_video_category'],$user_id);?></td>
							  <td align="left" valign="middle" class="box_pink"><?=$data['assign_video_name'];?></td>
							  <td align="center" valign="middle" class="box_pink"><?=$data['assign_video_status'];?></td>
							  <td align="center" valign="middle" class="box_pink"><a href="list_video_edit.php?id=<?=$data['assign_video_id'];?>&return_url=<?=urlencode($_SERVER['REQUEST_URI']);?>" class="bodytext_link">Edit</a></td>
							  <td align="center" valign="top" class="box_pink"><input name="chkSelect[]" id="chkSelect1" type="checkbox" value="<?=$data['assign_video_id'];?>" class="checkboxstyle"></td>
							</tr>
							<?
							}
							?>

        ...
        <table width="100%" cellspacing="0">
          <tbody>
            <tr>
              ...
              <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="user_edit.php?user_pid=<?=$user_id?>" class="bodytext_bold_link">Add
                  User</a></td>
            </tr>
          </tbody>
        </table>
						   ...
						   <?php }?>
							...
							<tr align="left" valign="top" class="box-bg">
							  ...
							  <td align="center" valign="middle">
							  	<a href="user_edit.php?id=<?=$data['user_id'];?>&user_pid=<?=$user_id?>&return_url=<?=urlencode($_SERVER['REQUEST_URI']);?>" class="bodytext_link">Edit</a><br/>
							  </td>

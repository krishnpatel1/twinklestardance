        ...
        <tbody>
          <tr>
            <td><!--<img src="images/icon/product.gif" alt="" width="24" height="24" border="0" class="admin_icon"/>-->
              <h3 class="icon-head head-promo-catalog">Special Subscription List
              </h3></td>
            <td class="form-buttons"><img src="images/add.gif" align="absmiddle"><a href="special_package_edit.php?sp_package_id=<?=$sp_package_id?>" class="bodytext_bold_link">Add Special Subscription</a></td>
          </tr>
        </tbody>
      </table>
    </div>
                    ...
                    <form name="form1" method="post" action="">
                      ...
                      <tr align="center" valign="middle">
                        <th width="49" align="left" valign="middle" class="bodytext_title_white">#</th>
						 <th width="150" align="center" valign="middle" class="bodytext_title_white">Subscription Image</th>
                        <th width="150" align="center" valign="middle" class="bodytext_title_white">Subscription Name</th>

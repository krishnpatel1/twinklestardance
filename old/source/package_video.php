...
$gallery_category_id=$_REQUEST['id'];
...
/*===============Pagination==================*/
$sql=$obj->selectData(TABLE_GALLERY,"","gallery_category_id LIKE '%,".$gallery_category_id.",%' and gallery_status='Active' ".$extra." order by gallery_name",2);
...
function setVideo(id,order_id)
{
	window.location='package_video.php?id='+id+'&order_id='+order_id;
}
</script>
<style type="text/css">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" class="video_page">
				  ...
				  <tr>
				  	<td align="left" valign="top">
						...
						<div id="video" class="top_box">
							...
							<div><?php echo $video_fetch['gallery_desc'];?></div>
					    </div>					</td>
				  </tr>
				  <tr>
				    ...
				    <td align="left" valign="top" class="gry_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top"><select name="id"  class="search_select" onchange="setVideo(this.value,'<?=$order_id?>')">
							<?php echo $obj->getcatNameSelect($order_id,$gallery_category_id);?>
						</select></td>
